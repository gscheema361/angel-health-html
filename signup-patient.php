				...
				<div class="col-md-12">
					<div class="login_area signup_area">
						...
						<div class="login_header mb-4 mt-2">
							<p><a href="signup-patient.php" class="active">Register Patients</a> <label> <a href="signup-doctor.php" >Are you a Doctor?</a></label></p>
						</div>
						...
						<div class="login_input_field">
							...
							<div class="act-or-not mt-4 ">
								<p>Have an account? <a href="login-patient.php">Login</a></p>
							</div>
