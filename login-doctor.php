				...
				<div class="col-md-12">
					<div class="login_area">
						...
						<div class="login_header mb-4 mt-2">
							<p><a href="login-patient.php">Login Patients</a> <label> <a href="login-doctor.php" class="active">Login Doctor</a></label></p>
						</div>
						...
						<div class="login_input_field">
							...
							<div class="act-or-not mt-4">
								<p>Don't have an account? <a href="signup-doctor.php">Register</a></p>
							</div>
